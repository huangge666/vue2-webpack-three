  ...
  <div>
    ...
    <div class="controls-box">
      ...
      <section>
        ...
        <el-row>
          <el-col :span="8"
                  class="label-col"><label> 环境光颜色</label></el-col>
          <el-col :span="16">
            <div @click="ambientLightInputClick">
              <el-input :value="ambientLightcolor"></el-input>
            </div>
            <div v-show="isShowAmbientLightColors"
                 class="color-select-layer">
              <sketch-picker v-model="ambientLightcolor"
                             @input="ambientLightColorChange"></sketch-picker>
            </div>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="8"
                  class="label-col"><label> 聚光灯颜色</label></el-col>
          <el-col :span="16">
            <div @click="inputClick">
              <el-input :value="lightProperties.color"></el-input>
            </div>
            <div v-show="isShowColors"
                 class="color-select-layer">
              <sketch-picker v-model="lightProperties.color"
                             @input="colorChange"></sketch-picker>
            </div>
          </el-col>
        </el-row>
        <el-row>
          <div v-for="(item,key) in lightProperties"
               :key="key">
        ...
        <el-row>
          <el-col :span="8"
                  class="label-col"><label>target</label></el-col>
          <el-col :span="16">
            <el-select v-model="lightProperties.target"
                       placeholder="请选择">
